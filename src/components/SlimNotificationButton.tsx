export default function SlimNotificationButton() {
   return <div className="mt-7 md:mt-10 flex flex-center highlight-none">
      <a aria-label="Contribute" className="inline-flex items-center justify-between px-1 py-1 pr-2 mb-5 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 hover:dark:bg-gray-700" role="alert" href="https://github.com/codeAbinash/leetcode-solutions" target="_blank">
